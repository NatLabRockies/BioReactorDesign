...
Vessel_vol = geompy.MakeFillet(Cylinder_1, 0.012, geompy.ShapeType["EDGE"], [9])
...
[Vertex_11,Vertex_12,Vertex_13,Vertex_14,Vertex_15,Vertex_16,Vertex_17,Vertex_18,Vertex_19,Vertex_20] = geompy.ExtractShapes(ports_centers, geompy.ShapeType["VERTEX"], True)
...
geomObj_17 = geompy.MakeFuseList([geomObj_5, geomObj_11, geomObj_14, geomObj_16], True, True)
[geomObj_18] = geompy.ExtractShapes(geomObj_17, geompy.ShapeType["SHELL"], True)
...
sparger = geompy.MakeFuseList([Cylinder_5, Sphere_1, Sphere_2, Extrusion_1, Cut_1], True, True)
...
Cut_2 = geompy.MakeCutList(vessel, [Fillet_2, Fillet_3, Fillet_4, Fillet_5, shaft, stirrer, sparger], True)
fluid_volume = geompy.MakePartition([Cut_2], [rotatingZone], [], [], geompy.ShapeType["SOLID"], 0, [], 0)
...
geompy.UnionIDs(stirrer_1, [374, 486, 835, 790, 271, 437, 820, 266, 215, 289, 348, 276, 848, 230, 490, 599, 684, 815, 149, 826, 468, 818, 464, 779, 484, 459, 625, 302, 813, 809, 862, 325, 756, 431, 338, 453, 589, 648, 475, 831, 807, 235, 457, 851, 842, 733, 508, 857, 523, 840, 630, 361, 513, 612, 697, 859, 410, 796, 720, 837, 594, 671, 307, 379, 518, 415, 481, 448, 574, 738, 853, 702, 769, 495, 743, 829, 846, 253, 397, 666, 824, 240, 154, 451, 462, 804, 473, 164, 470, 492, 794, 479, 420, 661, 159, 312, 503, 506, 435, 501, 635, 384, 707, 343, 774, 497])
...
geompy.UnionIDs(walls, [4, 65, 11, 95, 139, 124, 56, 135, 105, 107, 39, 75, 114, 41, 80, 46, 85, 16, 70])
[inlet_1, outlet_1, shaft_1, stirrer_1, static, rotating, walls] = geompy.GetExistingSubObjects(fluid_volume, False)
...
[ inlet_2, outlet_2, shaft_2, stirrer_2, static_1, rotating_1, walls_1 ] = STR.GetGroups()
...
[ inlet_2, outlet_2, shaft_2, stirrer_2, static_1, rotating_1, walls_1 ] = STR.GetGroups()
try:
  STR.ExportUNV( r'/home/federico/OpenFOAM/federico-13/run/STR_tetra/constant/geometry/salome/STR_finer.unv', 0 )
  pass
except:
...
[ inlet_2, outlet_2, shaft_2, stirrer_2, static_1, rotating_1, walls_1, faceRotating_1 ] = STR.GetGroups()
try:
  STR.ExportUNV( r'/home/federico/OpenFOAM/federico-13/run/STR_tetra_rotating/STR.unv', 0 )
  pass
except:
...
try:
  ...
  print('ExportUNV() failed. Invalid file name?')
[ inlet_2, outlet_2, shaft_2, stirrer_2, static_1, rotating_1, walls_1, faceRotating_1 ] = STR.GetGroups()
Viscous_Layers_1 = NETGEN_1D_2D_3D.ViscousLayers(1,2,1.2,[ 90, 119, 137 ],0,smeshBuilder.SURF_OFFSET_SMOOTH)
